...
voronoi <- deldir(clust.means[,3],clust.means[,2], rw = c(xrng, yrng))
# draw boundary box
lat <- c(1.405, 1.45)                
...
The purple cluster center is close to the first suspects home (red outline). However, I also noted that the algorithm incorrectly assigned the latest incident on 30 Dec (blue outline) to the purple cluster. Perhaps including the incident date in our feature set could prevent such erroneous assignment?
