...
The resultant clusters are shown below, denoted by the crosses. The clusters are even sized (about 6-7 incidents each).
...
The purple cluster center is close to the first suspects home. However, I also noted that the algorithm incorrectly assigned the latest incident on 30 Dec to the purple cluster. Perhaps including the incident date in our feature set could prevent such erroneous assignment?
